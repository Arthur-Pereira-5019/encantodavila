...
function ac_tripla_fix(resize) {
    if (calc_ac_t_l() % ac_cards_vw != 0) {
        ac_slide_tripla.style.left = (calc_ac_t_l() - calc_ac_t_l() % ac_cards_vw) + "vw"
    }
    if (resize) {
        if (calc_ac_t_l() <= -20 * ac_cards_vw) {
            ac_slide_tripla.style.left = "0vw"
...
function ac_quadrupla_fix(resize) {
    if (calc_ac_q_l() % ac_cards_vw != 0) {
        ac_slide_tripla.style.left = (calc_ac_q_l() - calc_ac_q_l() % ac_cards_vw) + "vw"
    }
    if (resize) {
        ...
        if (calc_ac_q_l() >= 0) {
            ac_slide_tripla.style.left = (-15 * ac_cards_vw) + "vw"
        }
    }
}
...
function ac_tripla_highlight() {
    ...
    const nball = Math.floor(Math.abs(calc_ac_t_l() / ac_cards_vw))
